...
extern HashTab *new_hastab(size_t size, vtype_tree_t key, vtype_tree_t value);
extern void free_hastab(HashTab *hashtab);
...
int main(void) {
	HashTab	*hashtab = new_hastab(10000, STRING_ELEM, DECIMAL_ELEM);
	set_hashtab(hashtab, string("hello, world!"), decimal(555));
